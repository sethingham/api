...
describe('GET /v1/technologies', function () {
    ...
    it('returns all technologies without pagination', function () {
        ...
        $response = $this->getJson('/v1/technologies')->assertOk();
    ...
    it('includes projects when requested', function () {
        ...
        $this->getJson('/v1/technologies?include=projects')
            ->assertOk()
